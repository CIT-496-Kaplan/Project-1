...
public class htmlUnitTest {
	...
	public static void main(String[] args) {
		...
		driver.get("http://192.168.1.23:4000");
		...
		String email = driver.findElement(By.cssSelector("a.u-email")).getText();
		System.out.println("Email found: " + email);
		Assert.assertTrue(email.contains("tony.nguyen.42@my.csun.edu"));
